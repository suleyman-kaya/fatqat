...
class MAVLink_loweheiser_gov_efi_message(MAVLink_message):
    ...
    fieldenums_by_name = {}
    fieldunits_by_name = {"volt_batt": "V", "curr_batt": "A", "curr_gen": "A", "curr_rot": "A", "fuel_level": "l", "throttle": "%", "runtime": "s", "until_maintenance": "s", "rectifier_temp": "degC", "generator_temp": "degC", "efi_batt": "V", "efi_rpm": "rpm", "efi_pw": "ms", "efi_fuel_consumed": "l", "efi_baro": "kPa", "efi_mat": "degC", "efi_clt": "degC", "efi_tps": "%", "efi_exhaust_gas_temperature": "degC"}
    native_format = bytearray("<ffffffIiffffffffffffHHB", "ascii")
    ...
    def __init__(self, volt_batt, curr_batt, curr_gen, curr_rot, fuel_level, throttle, runtime, until_maintenance, rectifier_temp, generator_temp, efi_batt, efi_rpm, efi_pw, efi_fuel_flow, efi_fuel_consumed, efi_baro, efi_mat, efi_clt, efi_tps, efi_exhaust_gas_temperature, efi_index, generator_status, efi_status):
...
class MAVLink(object):
    ...
    def loweheiser_gov_efi_encode(self, volt_batt, curr_batt, curr_gen, curr_rot, fuel_level, throttle, runtime, until_maintenance, rectifier_temp, generator_temp, efi_batt, efi_rpm, efi_pw, efi_fuel_flow, efi_fuel_consumed, efi_baro, efi_mat, efi_clt, efi_tps, efi_exhaust_gas_temperature, efi_index, generator_status, efi_status):
        """
        Composite EFI and Governor data from Loweheiser equipment.  This
    ...
    def loweheiser_gov_efi_send(self, volt_batt, curr_batt, curr_gen, curr_rot, fuel_level, throttle, runtime, until_maintenance, rectifier_temp, generator_temp, efi_batt, efi_rpm, efi_pw, efi_fuel_flow, efi_fuel_consumed, efi_baro, efi_mat, efi_clt, efi_tps, efi_exhaust_gas_temperature, efi_index, generator_status, efi_status, force_mavlink1=False):
        """
        Composite EFI and Governor data from Loweheiser equipment.  This
        message is created by the EFI unit based on its own data and
        data received from a governor attached to that EFI unit.
        ...
        """
        return self.send(self.loweheiser_gov_efi_encode(volt_batt, curr_batt, curr_gen, curr_rot, fuel_level, throttle, runtime, until_maintenance, rectifier_temp, generator_temp, efi_batt, efi_rpm, efi_pw, efi_fuel_flow, efi_fuel_consumed, efi_baro, efi_mat, efi_clt, efi_tps, efi_exhaust_gas_temperature, efi_index, generator_status, efi_status), force_mavlink1=force_mavlink1)
