...
class Ui_FatqatMainWindow(object):
    def setupUi(self, FatqatMainWindow):
        ...
        FatqatMainWindow.resize(858, 560)
        ...
        self.line_9.setGeometry(QtCore.QRect(550, 60, 301, 16))
        ...
        self.ImportedFileLabel.setGeometry(QtCore.QRect(710, 10, 231, 21))
        self.ImportedFileLabel.setObjectName("ImportedFileLabel")
        self.ExportedFileLabel = QtWidgets.QLabel(self.centralwidget)
        self.ExportedFileLabel.setGeometry(QtCore.QRect(710, 40, 231, 21))
